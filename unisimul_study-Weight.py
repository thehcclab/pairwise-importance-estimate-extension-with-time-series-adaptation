...
if __name__=="__main__":
    ...
    parser= argparse.ArgumentParser(description='This script is used to produce the baselines for PIEE\'s Weight-Naive method. It stores the training-validation split of the data for later use.')
    ...
    feat= f"unisimul_study{args.opt}-Weight"

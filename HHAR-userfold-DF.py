...
def main():
    ...
    for i in range(len(USERS)):
        ...
        model= Models.MultivariateSeries_DF(device=DEVICE, input_dim=input_dim, model=baseline_model, l1_lambda=config["l1_lambda"], l2_lambda=config["l2_lambda"]).to(DEVICE)

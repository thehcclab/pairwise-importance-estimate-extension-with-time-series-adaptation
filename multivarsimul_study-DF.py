...
def main():
    ...
    model= Models.Multivariate_DF(device=device, input_dim=data.X.shape[1:], model=baseline_model, l1_lambda=config["l1_lambda"], l2_lambda=config["l2_lambda"]).to(device)
...
if __name__=="__main__":
    ...
    feat= f"multivarsimul_study{args.opt}-DF"

...
def main():
    ...
    model= Models.MultivariateSeries_IELayer(device=device, input_dim=data.X.shape[2],
...
if __name__=="__main__":
    ...
    parser= argparse.ArgumentParser(description='This script is used to produce the baselines for PIEE\'s Weight-Naive Element-wise Multiplication method, and stores the training-validation split of the data for later use.')

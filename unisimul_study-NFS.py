...
def main():
    ...
    baseline_model= UnivariateSimulationStudyBaseline_Model(device=device, input_dim=input_dim, classes=classes).to(device)
...
if __name__=="__main__":
    ...
    parser= argparse.ArgumentParser(description='This script is used to produce the baselines for the NFS method. It stores the training-validation split of the data for later use.')
    ...
    feat= f"unisimul_study{args.opt}-NFS"

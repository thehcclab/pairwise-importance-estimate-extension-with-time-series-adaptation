...
def main():
    ...
    model= Models.Multivariate_IELayer(device=device, input_dim=data.X.shape[1:],
    ...
    pickle.dump( model.return_IE_weights(), open(dir_path+feat+"-w-"+str(config["epoch"])+".pkl", "wb") )
    return model
